...
<head>
    ...
    <script src="{{url('lib/layui/lay/modules/form.js')}}" charset="utf-8"></script>
    <script src="{{url('lib/layui/lay/modules/layer.css')}}" charset="utf-8"></script>
...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="./index.html">乐美商城后台管理系统</a></div>
    <div class="left_open">
